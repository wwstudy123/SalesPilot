...
from sale_agent.internal_api.deps import get_run_service, require_internal_auth
from sale_agent.internal_api.dto import CreateRunRequest, InstructionRequest, PauseRunRequest, ResumeRunRequest
from sale_agent.internal_api.errors import ApiError
from sale_agent.internal_api.mappers import envelope, map_create_run, map_event, map_events, map_instruction_ack, map_pause_ack, map_run
from sale_agent.internal_api.response_dto import (
    AckPayload,
    CreateRunPayload,
    Envelope,
    ErrorResponse,
